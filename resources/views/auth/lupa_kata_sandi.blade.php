    ...
    <div class="container">
        ...
        <div class="login-container">
            <form action="{{ URL::to('/kirim_email_reset') }}" method="POST">
                ...
                @if ($response)
                    @if ($response == 200)
                        <p class="m-0 mt-3 p-0 text-success">kode reset password telah dikirim ke whatsap anda anda,
                            <span class="text-warning">Jika email tidak masuk periksa email spam</span></p>
                    @elseif ($response == 500)
                ...
                <table style="width: 100%">
                    <tr>
                        <td>
                            <a href="{{ URL::to('/bantuan') }}"><i class="fas fa-question-circle"></i>
                                <span>Bantuan</span></a>
                        </td>
                        <td>
