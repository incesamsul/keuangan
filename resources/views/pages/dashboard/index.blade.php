                            ...
                            <tr>
                                ...
                                <td hidden>
                                    @if (substr($item->no_akun,0,1) == 1 || substr($item->no_akun,0,1) == 6)
                                        ...
                                        <?php
                                        $totalDebit += App\Models\Jurnal::where('id_akun', $item->id_akun)->where('id_periode',getPeriodeAktif()->id_periode)->whereMonth('tgl_transaksi', '=', $bulan)->get()->sum('debit') - App\Models\Jurnal::where('id_akun', $item->id_akun)->where('id_periode',getPeriodeAktif()->id_periode)->whereMonth('tgl_transaksi', '=', $bulan)->get()->sum('kredit');
                                        ?>
                                    @else
                                        Rp. -
                                    @endif
                                ...
                                <td hidden>
                                    @if (substr($item->no_akun,0,1) == 2 || substr($item->no_akun,0,1) == 3 || substr($item->no_akun,0,1) == 4)
                                        ...
                                        <?php
                                            $totalKredit += App\Models\Jurnal::where('id_akun', $item->id_akun)->where('id_periode',getPeriodeAktif()->id_periode)->whereMonth('tgl_transaksi', '=', $bulan)->get()->sum('kredit') - App\Models\Jurnal::where('id_akun', $item->id_akun)->where('id_periode',getPeriodeAktif()->id_periode)->whereMonth('tgl_transaksi', '=', $bulan)->get()->sum('debit');
                                         ?>
                                    @else
                                        Rp. -
                                    @endif
